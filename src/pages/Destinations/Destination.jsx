      ...
      <div className="cards">
        <div className="card">
          ...
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
              and cuisine. The city is famous for its iconic landmarks such as
        ...
        <div className="card">
          ...
          <div className="card-image">
            <img src={rome} alt="Paris" className="card-image-img" />
          </div>
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
        ...
        <div className="card">
          ...
          <div className="card-image">
            <img src={mombasa} alt="Paris" className="card-image-img" />
          </div>
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
        ...
        <div className="card">
          ...
          <div className="card-image">
            <img src={kisumu} alt="Paris" className="card-image-img" />
          </div>
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
        ...
        <div className="card">
          ...
          <div className="card-image">
            <img src={dubai} alt="Paris" className="card-image-img" />
          </div>
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
        ...
        <div className="card">
          ...
          <div className="card-image">
            <img src={brazil} alt="Paris" className="card-image-img" />
          </div>
          <div className="card-description">
            <p>
              Paris, the capital of France, is a global center for art, fashion,
